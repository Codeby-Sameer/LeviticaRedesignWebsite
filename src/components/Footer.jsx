...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { name: 'Custom Software Engineering', path: '/services/custom-software' },
    ...
    technologies: [
      { name: 'React & Next.js', path: '/technologies/frontend' },
      { name: 'Node.js & Python', path: '/technologies/backend' },
      { name: 'AWS & Azure Cloud', path: '/technologies/cloud' },
      { name: 'AI/ML Frameworks', path: '/technologies/ai' },
      { name: 'Database Systems', path: '/technologies/database' },
      { name: 'DevOps Tools', path: '/technologies/devops' },
    ],
    company: [
