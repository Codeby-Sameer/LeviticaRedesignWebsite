...
// import { Brain, Bot, Target, Zap, Eye, MessageSquare, TrendingUp, Cpu, ArrowRight, CheckCircle, Cloud, Code, Database, Shield } from 'lucide-react';
// import AnimatedBackground from '../components/AnimatedBackground';
...
//         "Adaptive user interfaces"
//       ],
//       color: isDark ? "from-blue-500 to-green-500" : "from-blue-600 to-green-700"
//     },
//     {
//       icon: Target,
//       title: "Computer Vision Solutions",
...
//         "Security & surveillance AI"
//       ],
//       color: isDark ? "from-green-500 to-blue-500" : "from-green-700 to-blue-800"
//     }
//   ];
...
//       animate={{ opacity: 1 }}
//       exit={{ opacity: 0 }}
//       className="pt-32 md:pt-24 overflow-x-hidden"
//     >
//       {/* Hero Section */}
...
//             <h1 className={`text-4xl md:text-5xl lg:text-5xl font-bold mb-6 transition-colors duration-300 ${isDark ? 'text-white' : 'text-slate-900'}`}>
//               AI Solutions
...
//                 transition={{ delay: index * 0.1 }}
//                 whileHover={{ y: -5 }}
//                 className={`group relative backdrop-blur-sm border rounded-xl p-6 transition-all duration-300 hover:scale-[1.02] ${isDark 
...
//               >
//                 <div className={`absolute inset-0 bg-gradient-to-r ${service.color} rounded-xl opacity-0 group-hover:opacity-5 transition-opacity duration-300`} />
                
//                 <div className="relative z-10">
//                   <div className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r ${service.color} rounded-lg mb-4 opacity-80 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110`}>
//                     <service.icon className="w-6 h-6 text-white" />
//                   </div>

//                   <h3 className={`text-xl font-semibold mb-3 transition-colors duration-300 ${isDark ? 'text-white group-hover:text-blue-300' : 'text-slate-900 group-hover:text-blue-700'}`}>
//                     {service.title}
//                   </h3>
...
//                         <div className={`w-1.5 h-1.5 rounded-full mr-3 ${isDark ? 'bg-blue-400' : 'bg-blue-600'}`} />
...
//                       {["TensorFlow", "PyTorch", "Keras", "Scikit-learn"].map((item, i) => (
//                         <li key={i} className={`flex items-center transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>
...
//                     </div>
//                     <ul className="space-y-2 text-sm">
//                       {["Python", "R", "JavaScript", "SQL"].map((item, i) => (
//                         <li key={i} className={`flex items-center transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>
//                           <CheckCircle className="w-3 h-3 mr-2" />
//                           {item}
//                         </li>
...
//                     </div>
//                     <ul className="space-y-2 text-sm">
//                       {["SageMaker", "Bedrock", "Comprehend", "Rekognition"].map((item, i) => (
//                         <li key={i} className={`flex items-center transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>
//                           <CheckCircle className="w-3 h-3 mr-2" />
//                           {item}
//                         </li>
...
//                     </div>
//                     <ul className="space-y-2 text-sm">
//                       {["Cognitive Services", "ML Studio", "OpenAI Service", "Synapse"].map((item, i) => (
//                         <li key={i} className={`flex items-center transition-colors duration-300 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>
//                           <CheckCircle className="w-3 h-3 mr-2" />
//                           {item}
//                         </li>
...
//                 Free AI readiness assessment included with consultation
//               </p>
//             </div>
//           </motion.div>
//         </div>
...
//             {[
//               { value: "40%", label: "Cost Reduction", desc: "Average efficiency gains" },
//               { value: "3x", label: "Faster Decisions", desc: "With AI insights" },
//               { value: "99%", label: "Accuracy Rate", desc: "In predictions & analysis" },
//               { value: "24/7", label: "AI Operations", desc: "Continuous intelligence" },
//             ].map((item, index) => (
//               <motion.div
//                 key={index}
//                 initial={{ opacity: 0, y: 20 }}
