...
import { 
  FaArrowLeft, FaUser, FaEnvelope, FaPhone, FaLinkedin, 
  FaGithub, FaFileAlt, FaPaperclip, FaUpload, FaCheck,
  FaBriefcase, FaGraduationCap, FaCalendar, FaMapMarkerAlt
} from 'react-icons/fa';
...
const ApplicationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const existingApplications = JSON.parse(localStorage.getItem('leviticaApplications') || '[]');
      
      // Add new application
      const updatedApplications = [...existingApplications, application];
      localStorage.setItem('leviticaApplications', JSON.stringify(updatedApplications));
      ...
      // Navigate to thank you page or back to careers
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center ${isDark ? 'bg-slate-900' : 'bg-gray-50'}`}>
        <div className="text-center">
          <div className={`text-2xl font-semibold mb-2 ${isDark ? 'text-white' : 'text-gray-900'}`}>
            Job not found
          </div>
          <button
  ...
  return (
    <div className={`min-h-screen py-20 ${isDark ? 'bg-slate-900' : 'bg-gray-50'}`}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {job && (
            <div className={`p-4 rounded-lg ${isDark ? 'bg-slate-800/50 border-slate-700' : 'bg-white border-gray-200'} border`}>
              <div className="flex flex-wrap gap-4 text-sm">
                <span className={`flex items-center ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <div className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors duration-300 ${
              ...
              {formData.resume ? (
                ...
                <label htmlFor="resume-upload" className="cursor-pointer">
                  <FaUpload className={`w-12 h-12 mx-auto mb-4 ${
