...
//   Shield, Users, Zap, Target, BarChart, Code, Cloud,
//   Smartphone, Cog, ExternalLink, MessageSquare, FileText
// } from 'lucide-react';
...
//     >
//       {/* Hero Section */}
//       <AnimatedBackground className="min-h-[50vh] flex items-center">
...
//               {/* <Link
//                 to="/services"
//                 className={`group inline-flex items-center cursor-pointer px-6 py-3 rounded-lg font-semibold transition-all duration-300 ${
//                   isDark 
...
//               {/* <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${service.color(isDark)} rounded-xl mb-6`}>
...
//               <p className={`text-md md:text-lg leading-relaxed mb-8 transition-colors duration-300 ${
...
//                 <button className={`inline-flex items-center px-6 py-3 border-2 rounded-lg font-semibold transition-all duration-300 ${
//                   isDark 
...
//               className={`lg:w-1/3 rounded-xl p-6 backdrop-blur-sm border ${
//                 isDark 
...
//                   <Clock className={`w-5 h-5 mr-3 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                   <div>
...
//                     }`}>4-8 weeks average</div>
//                   </div>
//                 </div>

//                 <div className="flex items-center">
//                   <DollarSign className={`w-5 h-5 mr-3 ${isDark ? 'text-green-400' : 'text-green-600'}`} />
//                   <div>
//                     <div className={`font-medium transition-colors duration-300 ${
//                       isDark ? 'text-white' : 'text-slate-900'
//                     }`}>ROI Guarantee</div>
//                     <div className={`text-sm transition-colors duration-300 ${
//                       isDark ? 'text-gray-400' : 'text-slate-600'
//                     }`}>12-18 months average</div>
//                   </div>
//                 </div>

//                 <div className="flex items-center">
//                   <Shield className={`w-5 h-5 mr-3 ${isDark ? 'text-cyan-400' : 'text-cyan-600'}`} />
//                   <div>
//                     <div className={`font-medium transition-colors duration-300 ${
//                       isDark ? 'text-white' : 'text-slate-900'
//                     }`}>Support</div>
//                     <div className={`text-sm transition-colors duration-300 ${
//                       isDark ? 'text-gray-400' : 'text-slate-600'
//                     }`}>24/7 monitoring & maintenance</div>
//                   </div>
//                 </div>

//                 <div className="flex items-center">
//                   <Users className={`w-5 h-5 mr-3 ${isDark ? 'text-purple-400' : 'text-purple-600'}`} />
//                   <div>
//                     <div className={`font-medium transition-colors duration-300 ${
//                       isDark ? 'text-white' : 'text-slate-900'
//                     }`}>Team Size</div>
//                     <div className={`text-sm transition-colors duration-300 ${
//                       isDark ? 'text-gray-400' : 'text-slate-600'
//                     }`}>Dedicated team of 5-10 experts</div>
//                   </div>
//                 </div>
//               </div>
//             </motion.div>
...
//                   className={`flex items-center px-6 py-4 font-medium transition-all duration-300 whitespace-nowrap border-b-2 ${
//                     activeTab === tab.id
//                       ? isDark
...
//                     isDark ? 'text-gray-300' : 'text-slate-600'
//                   }`}>
//                     We follow an agile methodology that ensures transparency, flexibility, and rapid delivery. Our process begins with in-depth discovery sessions to understand your unique challenges and opportunities.
//                   </p>
//                 </div>
//                 <div>
//                   <h3 className={`text-2xl font-bold mb-4 transition-colors duration-300 ${
...
//                   }`}
//                 >
//                   <div className={`inline-flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-r ${service.color(isDark)} mb-4`}>
...
//                       isDark ? 'text-gray-400' : 'text-slate-600'
//                     }`}>
//                       Implementation of comprehensive solution resulting in significant business impact.
//                     </p>
