...
//       animate={{ opacity: 1 }}
//       exit={{ opacity: 0 }}
//       className="pt-36 md:pt-24 w-full max-w-[100vw] overflow-x-hidden relative"
//     >
//       {/* Hero Section */}
...
//       <div className="space-y-5 md:space-y-14 py-6 md:py-20">
...
//               <div className={`flex flex-col ${section.reversed ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 lg:gap-20 items-center`}>
//                 {/* Image Section */}
//                 <motion.div
//                   initial={{ opacity: 0, x: section.reversed ? 50 : -50 }}
...
//                         src={section.image}
//                         alt={section.title}
//                         className="w-full max-h-[400px] md:max-h-[500px] object-cover transform group-hover:scale-110 transition-transform duration-700"
//                       />
//                       {/* Gradient Overlay */}
...
//                     {/* Decorative Elements */}
//                     <div className={`absolute -bottom-4 -left-4 w-32 h-32 ${isDark 
//                         ? 'bg-blue-500/10' 
//                         : 'bg-blue-600/10'} rounded-full blur-2xl -z-10`} />
//                     <div className={`absolute -top-4 -right-4 w-24 h-24 ${isDark 
//                         ? 'bg-cyan-500/10' 
...
//                       : 'bg-white/70 border-slate-200/50 hover:border-blue-300/50 hover:bg-white/90 shadow-lg hover:shadow-xl'}`}
//                 >
//                   {/* <div className={`text-2xl font-bold mb-4 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
//                     {step.number}
//                   </div> */}
...
//                   className={`text-sm flex items-center transition-colors duration-300 ${isDark 
//                       ? 'text-gray-400 hover:text-blue-400' 
//                       : 'text-slate-600 hover:text-blue-600'}`}
//                 >
//                   <div className={`w-3 h-3 rounded-full mr-2 ${isAutoPlaying 
//                       ? (isDark ? 'bg-green-500' : 'bg-green-600') 
//                       : (isDark ? 'bg-red-500' : 'bg-red-600')}`} />
//                   {isAutoPlaying ? 'Auto-rotating' : 'Click to rotate'}
//                 </button>
//               </div> */}
//             </div>
//           </div>
...
//   hero3: "/services/cybersecurity.jpg",
//   hero4: "/services/web-development.jpg",
//   hero5: "/services/software-testing.jpg",
// };
...
//                 scale: index === activeHeroImage ? 1 : 1.05
//               }}
...
//         <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 py-10">
//           <div className="max-w-7xl mx-auto">
//             {/* Image Carousel Controls - Top Right */}
//             <div className="absolute top-8 right-8 z-20 hidden lg:block">
//               <div className="flex items-center space-x-2">
//                 <button
//                   onClick={prevHeroImage}
//                   className={`p-2 rounded-full transition-all duration-300 ${isDark 
//                       ? 'bg-slate-800/50 border border-slate-700/50 text-white hover:bg-blue-500/20 hover:border-blue-400/50 hover:shadow-glow' 
//                       : 'bg-white/70 border border-slate-200/50 text-slate-700 hover:bg-blue-50 hover:border-blue-300 hover:shadow-md'}`}
//                 >
//                   <ChevronLeft className="w-5 h-5" />
//                 </button>
...
//                     className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium mb-4 border transition-all duration-300 ${isDark 
//                         ? 'bg-blue-500/10 border-blue-400/20 text-blue-400 hover:bg-blue-500/20 hover:border-blue-400/30' 
//                         : 'bg-white/70 border-slate-200/50 text-blue-700 hover:bg-white hover:border-blue-300 shadow-sm'}`}>
//                     <Sparkles className="w-4 h-4 mr-2" />
...
//                     className={`text-sm font-medium mb-2 transition-colors duration-300 ${isDark ? 'text-blue-300' : 'text-blue-600'}`}
//                   >
//                     {heroImages[activeHeroImage].subtitle}
//                   </motion.h2>
//                 </div>
...
//                     className={`p-4 rounded-xl backdrop-blur-sm border transition-all duration-300 ${isDark 
//                         ? 'bg-slate-800/30 border-slate-700/30 hover:border-blue-400/30 hover:bg-slate-800/50' 
//                         : 'bg-white/70 border-slate-200/50 hover:border-blue-300/50 hover:bg-white/90 shadow-sm hover:shadow-md'}`}
//                   >
//                     <div className="flex items-center justify-center mb-2">
//                       <div className={`p-2 rounded-lg ${isDark 
//                           ? 'bg-blue-500/20 text-blue-400' 
