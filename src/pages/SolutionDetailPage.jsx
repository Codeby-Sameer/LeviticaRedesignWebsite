...
// import { ArrowLeft, ArrowRight, Calendar, Clock, Users, Target, CheckCircle, DollarSign, BarChart, Shield, Zap, Globe, Code, Database, Cloud, MessageSquare, TrendingUp, Cpu, Brain, Eye, Sparkles, BookOpen, Headphones, FileText, Layers, Filter, PieChart, LineChart, Settings, Terminal } from 'lucide-react';
// import { useTheme } from '../contexts/ThemeContext';
// import { aiSolutionsData, getSolutionById } from '../data/aiSolutionsData';
...
//         <div className={`text-lg ${isDark ? 'text-white' : 'text-slate-900'}`}>Loading solution details...</div>
//       </div>
//     );
//   }
...
//       animate={{ opacity: 1 }}
//       exit={{ opacity: 0 }}
//       className="pt-32 md:pt-24 min-h-screen"
//     >
//       {/* Hero Section */}
//       <div className={`relative py-12 md:py-16 ${isDark ? 'bg-slate-900/50' : 'bg-gray-50'}`}>
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8">
//             <div className="lg:w-2/3">
//               <Link 
//                 to="/ai-solutions" 
//                 className={`inline-flex items-center text-sm font-medium mb-6 transition-colors duration-300 ${isDark ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-700'}`}
//               >
//                 <ArrowLeft className="w-4 h-4 mr-2" />
//                 Back to AI Solutions
//               </Link>
...
//                 <div className={`p-3 rounded-lg bg-gradient-to-r ${solution.color(isDark)}`}>
//                   <Icon className="w-8 h-8 text-white" />
//                 </div>
//                 <span className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border transition-all duration-300 ${isDark 
...
//               <p className={`text-xl md:text-2xl leading-relaxed transition-colors duration-300 mb-8 ${isDark ? 'text-gray-300' : 'text-slate-600'}`}>
//                 {solution.fullDescription}
//               </p>

//               {/* Quick Stats */}
//               <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
//                 <div className={`p-4 rounded-lg backdrop-blur-sm border ${isDark 
//                     ? 'bg-slate-800/30 border-slate-700/50' 
//                     : 'bg-white/70 border-slate-200/50'}`}>
//                   <div className="flex items-center mb-2">
//                     <Clock className={`w-5 h-5 mr-2 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                     <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Timeline</div>
//                   </div>
//                   <div className={`font-bold text-lg ${isDark ? 'text-white' : 'text-slate-900'}`}>{solution.timeline}</div>
//                 </div>
...
//                     <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Team Size</div>
//                   </div>
//                   <div className={`font-bold text-lg ${isDark ? 'text-white' : 'text-slate-900'}`}>{solution.team.size}</div>
//                 </div>
...
//                     : 'bg-white/70 border-slate-200/50'}`}>
//                   <div className="flex items-center mb-2">
//                     <Target className={`w-5 h-5 mr-2 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                     <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Success Rate</div>
//                   </div>
//                   <div className={`font-bold text-lg ${isDark ? 'text-white' : 'text-slate-900'}`}>95%+</div>
//                 </div>
...
//                     : 'bg-white/70 border-slate-200/50'}`}>
//                   <div className="flex items-center mb-2">
//                     <DollarSign className={`w-5 h-5 mr-2 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                     <div className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>Starting From</div>
//                   </div>
//                   <div className={`font-bold text-lg ${isDark ? 'text-white' : 'text-slate-900'}`}>
//                     {Object.values(solution.pricingModels)[0].split('(')[0]}
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//               <div className={`sticky top-32 backdrop-blur-sm border rounded-2xl p-6 ${isDark 
...
//                     className={`group relative w-full inline-flex items-center justify-center px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 ${isDark 
...
//                     to="/demo"
//                     state={{ solution: solution.title }}
//                     className={`w-full inline-flex items-center justify-center px-6 py-3 border-2 rounded-lg font-semibold transition-all duration-300 ${isDark 
...
//                   <h4 className={`font-semibold mb-3 ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>Quick Facts</h4>
...
//                   className={`p-6 rounded-xl backdrop-blur-sm border transition-all duration-300 hover:scale-105 ${isDark 
...
//                     <div className={`w-10 h-10 rounded-lg flex items-center justify-center mr-4 ${isDark 
//                         ? 'bg-blue-500/20' 
//                         : 'bg-blue-100'}`}>
...
//                   <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mr-4 ${isDark 
//                       ? 'bg-green-500/20' 
//                       : 'bg-green-100'}`}>
...
//                 Technology Stack
//               </h2>
//               <div className={`p-6 rounded-xl backdrop-blur-sm border ${isDark 
//                   ? 'bg-slate-800/50 border-slate-700/50' 
//                   : 'bg-white/70 border-slate-200/50 shadow-lg'}`}>
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                   {solution.technologies.map((tech, index) => (
//                     <div key={index} className="flex items-center">
//                       <Code className={`w-5 h-5 mr-3 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                       <span className={isDark ? 'text-gray-300' : 'text-slate-700'}>{tech}</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//                   >
//                     <div className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center mr-4 mt-1 ${isDark 
...
//                       ? 'bg-slate-800/50 border border-slate-700/50 text-blue-400 hover:bg-blue-500/20' 
//                       : 'bg-white/70 border border-slate-200/50 text-blue-600 hover:bg-blue-50'}`}
//                 >
...
//               <div className="p-8">
//                 <div className="flex items-center mb-4">
//                   <div className={`p-2 rounded-lg ${isDark ? 'bg-blue-500/20' : 'bg-blue-100'} mr-4`}>
//                     <BarChart className={`w-6 h-6 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                   </div>
//                   <div>
//                     <h3 className={`text-xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>
//                       {solution.caseStudies[selectedCaseStudy].title}
//                     </h3>
//                     <div className={`text-sm font-semibold mt-1 ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
...
//                   className={`w-3 h-3 rounded-full transition-all duration-300 ${index === selectedCaseStudy 
...
//                     viewport={{ once: true }}
//                     transition={{ delay: index * 0.1 }}
//                     className={`p-6 rounded-xl backdrop-blur-sm border ${isDark 
//                         ? 'bg-slate-800/50 border-slate-700/50' 
//                         : 'bg-white/70 border-slate-200/50 shadow-lg'}`}
//                   >
...
//                       </h3>
//                       <div className={`text-2xl font-bold bg-gradient-to-r bg-clip-text text-transparent ${solution.color(isDark)}`}>
//                         {price}
//                       </div>
//                     </div>
//                     <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-slate-600'}`}>
...
//                   <Users className={`w-6 h-6 mr-3 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
//                   <div>
...
//                 <div className="space-y-4">
//                   <h4 className={`font-semibold ${isDark ? 'text-gray-300' : 'text-slate-700'}`}>Team Roles:</h4>
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
//                     {solution.team.roles.map((role, index) => (
//                       <div key={index} className="flex items-center">
//                         <div className={`w-2 h-2 rounded-full mr-3 ${isDark ? 'bg-blue-400' : 'bg-blue-600'}`} />
...
//                     viewport={{ once: true }}
//                     transition={{ delay: index * 0.1 }}
//                     className={`p-6 rounded-xl backdrop-blur-sm border text-center ${isDark 
//                         ? 'bg-slate-800/50 border-slate-700/50' 
//                         : 'bg-white/70 border-slate-200/50 shadow-lg'}`}
//                   >
//                     <div className={`text-3xl font-bold mb-2 bg-gradient-to-r bg-clip-text text-transparent ${solution.color(isDark)}`}>
...
//                 <span
//                   key={index}
//                   className={`px-4 py-2 rounded-full text-sm font-medium border transition-all duration-300 ${isDark 
//                       ? 'bg-slate-800/50 border-slate-700/50 text-gray-300 hover:border-blue-400/50 hover:text-blue-300' 
//                       : 'bg-white/70 border-slate-200/50 text-slate-700 hover:border-blue-300/50 hover:text-blue-600'}`}
//                 >
//                   {industry}
//                 </span>
//               ))}
...
//             Transform your business with this proven AI solution. Contact us today for a personalized consultation.
//           </p>
